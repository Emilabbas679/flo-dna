...
class Pofile(object):
    ...
    def __init__(self, locale="az"):
        ...
        self.po = polib.pofile(
            os.path.join(os.getcwd(), r'{}/translations/{}/LC_MESSAGES/{}.po'.format(self.path,\
                                                                                     self.locale, self.filename)))

    def get_po(self):
        return self.po

    def po_filter_values(self, filter=None):
    ...
    def filter_pagination(self, filter=None):
        page, per_page, offset = get_page_args(page_parameter='page',
                                               per_page_parameter='per_page')
        po_entries = self.po_filter_values(filter)
    ...
    def po_update(self, msgid, msgstr):
        ...
        self.po.save(os.path.join(os.getcwd(), r'{}/translations/{}/LC_MESSAGES/{}.po'.format(self.path,\
                                                                                              self.locale, self.filename)))
        os.system('pybabel compile -d core/translations')
        return True
